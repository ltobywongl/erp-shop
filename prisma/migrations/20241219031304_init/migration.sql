...
CREATE TABLE `enquiries` (
    ...
    INDEX `enquiries_users_FK`(`user_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `order_items` (
    ...
    INDEX `order_items_orders_FK`(`order_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
    ...
    `updated_at` DATETIME(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0),
    `deleted_at` DATETIME(0) NULL,
    `topupId` VARCHAR(36) NULL,

    INDEX `orders_users_FK`(`user_id`),
    INDEX `orders_coupons_FK`(`coupon_id`),
    INDEX `orders_payments_FK`(`payment_id`),
    INDEX `orders_topupId_fkey`(`topupId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `orders` ADD CONSTRAINT `orders_topupId_fkey` FOREIGN KEY (`topupId`) REFERENCES `topups`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
